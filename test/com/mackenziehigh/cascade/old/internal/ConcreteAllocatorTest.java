...
import com.mackenziehigh.cascade.old.CascadeAllocator.AllocatorMismatchException;
import com.mackenziehigh.cascade.old.CascadeAllocator.ExhaustedAllocationPoolException;
...
import com.mackenziehigh.cascade.old.internal.ConcreteAllocator.FixedAllocationPool;
...
public final class ConcreteAllocatorTest
{
    ...
    public void test20171120000935135207 ()
    {
         ...
         * Method: copyTo(byte[])
         */
        testThrow(NullPointerException.class, x -> x.push("X").copyTo(null));

        /**
         * Method: copyTo(byte[], int)
         */
        final byte[] buffer1 = new byte["XYZ".length()];
        testThrow(NullPointerException.class, x -> x.push("X").copyTo(null, 0));
        ...
        testThrow(NullPointerException.class, x -> x.push("X").copyTo(null, 0, 1));
