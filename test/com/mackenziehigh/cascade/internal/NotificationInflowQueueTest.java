 ...
 * Unit Test.
 */
public final class NotificationInflowQueueTest
{
    private final LinkedInflowQueue delegate = new LinkedInflowQueue(5);

    private final List<InflowQueue> callbacks = Lists.newArrayList();

    private final NotificationInflowQueue queue = new NotificationInflowQueue(delegate, x -> callbacks.add(x));
    ...
    /**
     * Test: 20180318194622823304
     *
     * <p>
     * Case: Zero Capacity Constructor
     * </p>
     */
    @Test (expected = IllegalArgumentException.class)
    public void test20180318194622823304 ()
    {
        System.out.println("Test: 20180318194622823304");
        new LinkedInflowQueue(0);
    }
