 ...
 * Unit Test.
 */
public final class SwappableInflowQueueTest
{
    private final LinkedInflowQueue delegate = new LinkedInflowQueue(5);

    private final SwappableInflowQueue queue = new SwappableInflowQueue(delegate);
    ...
    /**
     * Test: 20180319230923484121
     *
     * <p>
     * Method: <code>replaceQueue</code>
     * </p>
     *
     * <p>
     * Case: Normal, Same Capacity
     * </p>
     */
    @Test
    public void test20180319230923484121 ()
    {
        System.out.println("Test: 20180319230923484121");
        ...
        final ArrayInflowQueue replacement = new ArrayInflowQueue(delegate.capacity());
        assertEquals(0, replacement.size());

        assertTrue(queue.getDelegate() == delegate); // Identity Equality
        queue.replaceDelegate(replacement);
        assertTrue(queue.getDelegate() == replacement); // Identity Equality
     ...
     *
     * <p>
     * Case: Normal, Smaller Capacity
     * </p>
     */
    @Test
    public void test20180319232059362501 ()
    {
        System.out.println("Test: 20180319232059362501");
        ...
        final ArrayInflowQueue replacement = new ArrayInflowQueue(delegate.capacity() - 2);
        assertEquals(0, replacement.size());
     ...
     *
     * <p>
     * Case: Normal, Larger Capacity
     * </p>
     */
    @Test
    public void test20180319232059362571 ()
    {
        System.out.println("Test: 20180319232059362571");
