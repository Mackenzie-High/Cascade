...
public final class ConcreteSchemaTest
{
    ...
    public void test ()
    {
        ...
        cs.usingPool("pool1");
        cs.usingPump("pump1");
        cs.addReactor().named("reactor1").withLinearArrayQueue(8).withCore(Cores.nop());
        cs.addReactor().named("reactor2").withLinearArrayQueue(8).withCore(Cores.nop());
        cas = cs.build();
        assertEquals("pump1", cas.pumps().get(CascadeToken.create("pump1")).name().toString());
        ...
        cs.usingPool("pool1");
        cs.addReactor().named("reactor1").withLinearArrayQueue(8).usingPump("pump1").withCore(Cores.nop());
        cs.addReactor().named("reactor2").withLinearArrayQueue(8).usingPump("pump2").withCore(Cores.nop());
        cas = cs.build();
