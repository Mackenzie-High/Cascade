...
public interface CascadeSchema
{
    ...
    public interface PoolSchema
    {
         ...
         * @return this.
         */
        public PoolSchema withMinimumSize (int bound);
         ...
         * @return this.
         */
        public PoolSchema withMaximumSize (int bound);
     ...
     *
     * <p>
     * Of note, a composite-pool can legally be a member-pool of another composite-pool.
     * However, that would be of questionable usefulness.
     * </p>
     */
    ...
    public interface ReactorSchema
    {
         ...
         *
         * <p>
         * The build() method will be invoked immediately.
         * </p>
         *
     ...
     * to use the given logger-factory, unless another logger or
     * logger-factory is explicitly specified for the reactor.
     *
     * <p>
     * The build() method will be invoked immediately.
     * </p>
    ...
    /**
     * This method causes reactors subsequently added to this scope
     * to use the given logger, unless another logger or logger-factory
