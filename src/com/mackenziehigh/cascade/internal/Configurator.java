...
import com.mackenziehigh.cascade.modules.common.BacklogBalancer;
import com.mackenziehigh.cascade.modules.common.BlowoutPreventor;
import com.mackenziehigh.cascade.modules.common.Clock;
import com.mackenziehigh.cascade.modules.common.ClockMerger;
import com.mackenziehigh.cascade.modules.common.Counter;
import com.mackenziehigh.cascade.modules.common.DuplicationBlocker;
import com.mackenziehigh.cascade.modules.common.Expression;
import com.mackenziehigh.cascade.modules.common.Forwarder;
import com.mackenziehigh.cascade.modules.common.HeartbeatMonitor;
import com.mackenziehigh.cascade.modules.common.Printer;
import com.mackenziehigh.cascade.modules.common.QueueMonitor;
import com.mackenziehigh.cascade.modules.common.RateLimiter;
import com.mackenziehigh.cascade.modules.common.Repeater;
import com.mackenziehigh.cascade.modules.common.ResourcePoller;
import com.mackenziehigh.cascade.modules.common.RoundRobinBalancer;
import com.mackenziehigh.cascade.modules.common.Summation;
import com.mackenziehigh.cascade.modules.common.Switcher;
import com.mackenziehigh.cascade.modules.common.Valve;
import com.mackenziehigh.cascade.modules.common.Variable;
import com.mackenziehigh.cascade.modules.os.Subprocess;
...
final class Configurator
{
...

    {
        ...
        imports.put("Counter", Counter.class.getName());
        imports.put("Summation", Summation.class.getName());
        imports.put("Repeater", Repeater.class.getName());
        imports.put("BacklogBalancer", BacklogBalancer.class.getName());
        imports.put("BlowoutPreventor", BlowoutPreventor.class.getName());
        imports.put("ClockMerger", ClockMerger.class.getName());
        imports.put("DuplicationBlocker", DuplicationBlocker.class.getName());
        imports.put("Expression", Expression.class.getName());
        imports.put("RateLimiter", RateLimiter.class.getName());
        imports.put("QueueMonitor", QueueMonitor.class.getName());
        imports.put("RoundRobinBalancer", RoundRobinBalancer.class.getName());
        imports.put("HeartbeatMonitor", HeartbeatMonitor.class.getName());
        imports.put("Subprocess", Subprocess.class.getName());
        imports.put("Switcher", Switcher.class.getName());
        imports.put("Valve", Valve.class.getName());
        imports.put("Variable", Variable.class.getName());

        Verify.verify(imports.keySet().stream().allMatch(key -> imports.get(key).contains(key)));
    }
