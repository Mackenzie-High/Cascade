...
{
    public abstract void resolveConnections (Token event,
     ...
     */
    public int broadcast (final Token event,
     ...
     */
    public boolean sendAsync (final Token event,
                              final OperandStack message)
    {
        if (transactionLock.tryLock() == false)
        {
     ...
     */
    public boolean sendSync (final Token event,
                             final OperandStack message,
                             final long timeout,
    ...
    private void resolveConnections (final Token event)
    {
